  ...
  <div class="sidebar-sticky"> 
    <ul class="nav flex-column"> 
      ...
      <li class="nav-item dropdown"> 
        <a href="#" role="button" data-toggle="collapse" data-bstoggle="dropdown" aria-expanded="false" class="nav-link dropdown-toggle">Product 
</a> 
...
List</a> 
      ...
      <li class="nav-item dropdown"> 
        <a href="#" role="button" data-toggle="collapse" data-bs
toggle="dropdown" aria-expanded="false" class="nav-link dropdown-toggle"> 
          User 
        </a> 
        <ul class="dropdown-menu"> 
          <li class="dropdown-item"> 
